...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop MessiahMetaCorp server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "MessiahMetaCorp server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MessiahMetaCorp features */
        {"messiahmetacorp", "listmasternodes", &listmasternodes, true, true, false},
        {"messiahmetacorp", "getmasternodecount", &getmasternodecount, true, true, false},
        {"messiahmetacorp", "masternodeconnect", &masternodeconnect, true, true, false},
        {"messiahmetacorp", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"messiahmetacorp", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"messiahmetacorp", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"messiahmetacorp", "masternodecurrent", &masternodecurrent, true, true, false},
        {"messiahmetacorp", "masternodedebug", &masternodedebug, true, true, false},
        {"messiahmetacorp", "startmasternode", &startmasternode, true, true, false},
        {"messiahmetacorp", "createmasternodekey", &createmasternodekey, true, true, false},
        {"messiahmetacorp", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"messiahmetacorp", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"messiahmetacorp", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"messiahmetacorp", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"messiahmetacorp", "getmasternodescores", &getmasternodescores, true, true, false},
        {"messiahmetacorp", "preparebudget", &preparebudget, true, true, false},
        {"messiahmetacorp", "submitbudget", &submitbudget, true, true, false},
        {"messiahmetacorp", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"messiahmetacorp", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"messiahmetacorp", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"messiahmetacorp", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"messiahmetacorp", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"messiahmetacorp", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"messiahmetacorp", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"messiahmetacorp", "checkbudgets", &checkbudgets, true, true, false},
        {"messiahmetacorp", "mnsync", &mnsync, true, true, false},
        {"messiahmetacorp", "spork", &spork, true, true, false},
        {"messiahmetacorp", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzmmcseed", &getzmmcseed, false, false, true},
        {"zerocoin", "setzmmcseed", &setzmmcseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzmmc", &searchdzmmc, false, false, true},
        {"zerocoin", "dzmmcstate", &dzmmcstate, false, false, true},
...
{
    return "> messiahmetacorp-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8019/\n";
}
