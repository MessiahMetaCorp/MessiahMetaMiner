...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("MessiahMetaCorp Core"),
     ...
     * override -datadir in the messiahmetacorp.conf file in the default data directory
     * (to be consistent with messiahmetacorpd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
