...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::MMC);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeMessiahMetaCorpAmount"))
        SoftSetArg("-anonymizemessiahmetacorpamount", settings.value("nAnonymizeMessiahMetaCorpAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in messiahmetacorp.cpp during shotdown to also remove the window positions
