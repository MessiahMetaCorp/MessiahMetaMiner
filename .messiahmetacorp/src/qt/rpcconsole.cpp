                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzMMCPathCustom = GetArg("-zmmcbackuppath", "");
    ...
    if(!strzMMCPathCustom.empty()) {
        ui->wallet_customzmmcbackuppath->setText(QString::fromStdString(strzMMCPathCustom));
        ui->wallet_customzmmcbackuppath_label->setVisible(true);
        ui->wallet_customzmmcbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzMMCPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the MessiahMetaCorp RPC console.") + "<br>" +
