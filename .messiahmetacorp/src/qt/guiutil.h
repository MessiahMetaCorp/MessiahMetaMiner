...
/** Utility functions used by the MessiahMetaCorp Qt UI.
 */
namespace GUIUtil
{
...
// Render MessiahMetaCorp addresses in monospace font
...
// Parse "messiahmetacorp:" URI into recipient object, return true on successful parsing
