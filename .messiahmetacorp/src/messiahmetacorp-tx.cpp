...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MessiahMetaCorp Core messiahmetacorp-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  messiahmetacorp-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded messiahmetacorp transaction") + "\n" +
                               "  messiahmetacorp-tx [options] -create [commands]   " + _("Create hex-encoded messiahmetacorp transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded messiahmetacorp transaction
