...
#ifndef MessiahMetaCorp_ZMMCTRACKER_H
#define MessiahMetaCorp_ZMMCTRACKER_H
...
public:
    CzMMCTracker(std::string strWalletFile);
    ~CzMMCTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzMMCWallet* zMMCWallet = NULL);
...
#endif //MessiahMetaCorp_ZMMCTRACKER_H
