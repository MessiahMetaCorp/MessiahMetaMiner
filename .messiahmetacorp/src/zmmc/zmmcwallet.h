...
#ifndef MessiahMetaCorp_ZMMCWALLET_H
#define MessiahMetaCorp_ZMMCWALLET_H
...
public:
    CzMMCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZMMC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZMMC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //MessiahMetaCorp_ZMMCWALLET_H
