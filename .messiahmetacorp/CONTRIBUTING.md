Contributing to MessiahMetaCorp Core
============================

The MessiahMetaCorp Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/messiahmetacorp-project/messiahmetacorp/blob/master/doc/translation_process.md)
...
The following applies to code changes to the MessiahMetaCorp Core project, and is not to be
confused with overall MessiahMetaCorp Network Protocol consensus changes.

Whether a pull request is merged into MessiahMetaCorp Core rests with the project merge
...
Patches that change MessiahMetaCorp consensus rules are considerably more involved than
...
Where a patchset proposes to change the MessiahMetaCorp consensus, it must have been
...
The project leader is the release manager for each MessiahMetaCorp Core release.
