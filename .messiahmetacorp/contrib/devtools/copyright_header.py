...
EXCLUDE = [
    # auto generated:
    'src/qt/messiahmetacorpstrings.cpp',
...
EXPECTED_HOLDER_NAMES = [
    ...
    "The MessiahMetaCorp developers\n",
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The MessiahMetaCorp developers'
...
Arguments:
    <base_directory> - The base directory of a messiahmetacorp source code repository.
"""
