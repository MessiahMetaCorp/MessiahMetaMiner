...
from fake_stake.base_test import MessiahMetaCorp_FakeStakeTest

class zMMCValidCoinSpendTest(MessiahMetaCorp_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zMMCs..." % DENOM_TO_USE)
